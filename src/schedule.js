...
export function ymdInTokyo(date) {
...
export function todayInTokyo() {
  return ymdInTokyo(new Date());
}

export function tomorrowInTokyo() {
...
export async function matchesForTokyoDate(targetDate) {
...
export function buildDiscordPayload(matches, targetDate) {
